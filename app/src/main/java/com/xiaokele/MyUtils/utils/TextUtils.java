...
import com.QiyiLive.live.widget.HandyTextView;
...
public class TextUtils {
    ...
    public static String getConstellation(int month, int day) {
        String[] constellationArr = {"水瓶座", "双鱼座", "白羊座", "金牛座", "双子座", "巨蟹座", "狮子座", "处女座", "天秤座", "天蝎座", "射手座",
                "魔羯座"};
    ...
    public static String clipString(String str, int end) {
        char[] buffer = new char[1024];
        str.getChars(0, end, buffer, 8);
    ...
    public static String escapeXml(String sText) {
        if (!android.text.TextUtils.isEmpty(sText)) {
     ...
     * @return
     */
    public static String escapehHttpXml(String sText) {
//		if(!android.text.TextUtils.isEmpty(sText)){
//			return sText.replace("&", "amp;").replace("<", "lt;").
//					replace(">", "gt;").replace("\"", "quot;").replaceAll("'", "apos;");
//		}
        return sText;
    }
     ...
     * @return
     */
    public static String unescapeHttpXml(String sText) {
//		if(!android.text.TextUtils.isEmpty(sText)){
//			return sText.replace("amp;", "&").replace("lt;", "<").
//					replace("gt;", ">").replace("quot;", "\"").replaceAll("apos;", "'");
//		}
